package aisco.product.withpayment;
...
public class WithPayment {
    ...
    public static void addDonation() {
        Donation donate = DonationFactory.createDonation("aisco.donation.directpayment.DonationImpl");
        donate.addDonation();
        donate.getDonation();
    }

    public static void main(String[] args) {
        System.out.println("Product With Beneficiary + Direct Payment");
