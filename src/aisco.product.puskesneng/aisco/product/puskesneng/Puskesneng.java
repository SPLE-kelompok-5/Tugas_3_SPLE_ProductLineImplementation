package aisco.product.puskesneng;
...
public class Puskesneng {
	...
	public static List<Program> setupPrograms() {
		...
		Program activity = ProgramFactory.createProgram(
				...
				1, "Puskesneng", "Financial Management", "Private Institution",
				"https://puskesneng.co.id");
	...
	public static void main(String[] args) {
		System.out.println("Starting Product: Puskesneng");
